...
export function OrderSummary({ subtotal, total }: OrderSummaryProps) {
  return (
    <div className="border-2 border-blue-400 rounded-lg p-6 bg-white">
      ...
      <Button className="w-full mt-6 bg-pink-500 hover:bg-pink-600 text-white">Proceed to checkout</Button>
      <p className="text-center text-sm text-muted-foreground mt-4">All cakes are freshly baked to order.</p>
    </div>
  )
}
