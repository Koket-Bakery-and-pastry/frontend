...
const categories = [
  ...
  {
    name: "Breads",
    image: "/assets/img2.png", // Updated to img3 for variety
...
function CategorySection() {
  return (
    <section className="py-20 px-4 md:py-24 bg-pink-50 mt-8">
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        >
          <h2 className="text-5xl md:text-6xl lg:text-7xl text-balance font-kaushan ">
            Shop by Category
          </h2>
