...
function CallToAction() {
  return (
    <section
      className="relative flex items-center   min-h-[350px] md:min-h-[500px] bg-center bg-cover px-24"
      style={{
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-24 py-12 ">
        <h2 className="text-4xl md:text-5xl font-kaushan mb-4 mt-28">
          Ready to Order Your Perfect Cake?
        </h2>
        <p className="text-2xl md:text-3xl font-kaushan mb-8">
