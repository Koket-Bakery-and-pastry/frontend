...
function OurValues() {
  return (
    <section className="bg-[#FFFAFF] py-12 px-24">
      <h2 className="text-3xl md:text-4xl font-kaushan text-center mb-16">
      ...
      <div className="flex flex-col md:flex-row justify-center items-start gap-10 md:gap-0">
        {values.map((v, i) => (
          ...
          >
            ...
            <p className="text-gray-700 max-w-xs">{v.desc}</p>
          </div>
        ))}
      </div>
    </section>
